describe('User Able To Validate Profile Name', function() {
   it('user Able To Validate Profile Name', function() {
     ...
     //Click Sign In Button
       ...
       element(by.className("ember3182-upload-photo")).click();
            
      expect(element(by.linkText('ember4421')).getTagName()).toBe('MD HOSSAIN');
